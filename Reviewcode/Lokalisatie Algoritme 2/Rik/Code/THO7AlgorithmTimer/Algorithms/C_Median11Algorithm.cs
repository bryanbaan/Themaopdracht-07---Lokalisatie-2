...
{
    class C_Median11Algorithm : VisionAlgorithm
    {
        [DllImport("../ImageProcessing.dll"
            , EntryPoint = "#5"
            , CallingConvention = CallingConvention.StdCall)]
        private static extern void Median_11(IntPtr originalImageData, IntPtr newImageData, int width, int height);

        public C_Median11Algorithm(String name) : base(name) { }
        public override System.Drawing.Bitmap DoAlgorithm(System.Drawing.Bitmap sourceImage)
        {
            ...
            Median_11(imageData.Scan0, returnData.Scan0, width, height);
